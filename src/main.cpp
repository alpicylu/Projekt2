...
void Test_dll_methods()
{
    ...
    int n_ent = 2000; //17 is the equilibriom point
    ...
    // {
    //     lista3.append(Packet<string>("cos", creation(rng)));
    //     lista4.append(Packet<string>("cos", creation(rng)));
    // }
